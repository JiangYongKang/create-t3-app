...
<Collapsible title="What does T3 stand for?" client:load>
  The "T3" in T3 Stack stands for **T**ypeScript, **T**ailwind, and **t**RPC. These three technologies form the core foundation of the stack, though you can swap out pieces as needed for your project.
</Collapsible>
